...
//            new QuestionAnswerPair("Is the Pacific deeper than the Atlantic?",      ANSWER_UNKNOWN,     Categories.GEOGRAPHY),
            new QuestionAnswerPair("Did Neeson star in Schindler?",                 ANSWER_YES,         Categories.MOVIES),
            new QuestionAnswerPair("Swank won the oscar in 2000?",                  ANSWER_YES,         Categories.MOVIES),
            new QuestionAnswerPair("Did Swank win the oscar in 2000?",              ANSWER_YES,         Categories.MOVIES),
